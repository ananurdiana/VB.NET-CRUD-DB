...
Public Class rptMahasiswa
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "VB.NET_CRUD_DB.rptMahasiswa.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptMahasiswa
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptMahasiswa = New rptMahasiswa()
        rpt.Site = Me.Site
        Return rpt
    End Function
